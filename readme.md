...
class Back4AppConfig {
  static const applicationId = 'YOUR_BACK4APP_APPLICATION_ID';
  static const clientKey = 'YOUR_BACK4APP_CLIENT_KEY';
...
## Notes
- Registration accepts student emails; you can add stricter domain checks in `register_screen.dart`.
- To enforce live updates across multiple devices in production, use Parse LiveQuery setup in Back4App.